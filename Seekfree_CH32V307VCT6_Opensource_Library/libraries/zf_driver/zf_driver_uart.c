 ...
 * @date            2021-11-25
 *                  V1.1 2022.02.13 修改部分不正确注释
 *                  V1.2 2022.03.26 删除以前的设置中断优先级函数
 ********************************************************************************************************************/
...
//  @param      uartn           串口模块号(UART_1 - UART_8)
//  @param      *dat            接收数据的地址
//  @return     void
//  Sample usage:               uint8 dat; uart_read_byte(UART_1,&dat);       // 接收串口1数据  存在在dat变量里
//-------------------------------------------------------------------------------------------------------------------
...
//  Sample usage:               uint8 dat; uart_query_byte(UART_1,&dat);       // 接收串口1数据  存在在dat变量里
//-------------------------------------------------------------------------------------------------------------------
